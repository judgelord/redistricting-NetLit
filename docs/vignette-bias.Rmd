...
-one measure of [shortest-path](https://igraph.org/c/doc/igraph-Structural.html#shortest-path-related-functions) = 3.15. `igraph_average_path_length`
-one measure of centrality (total? average?) 
-one measure of vertex degree (total? average?) 
-one measure of closeness (total? average?) 
-one measure of betweeness (total? average?) 
-one measure of eignevector centrality (total? average?) 
-one measure of connected-components, and clusters and bridges (total? average?) 
