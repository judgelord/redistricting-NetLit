...
```{r igraph2, fig.width=8, fig.height=6}
plot(g,
...
```{r ggnetwork, fig.width=7, fig.height=6}
...
```{r ggnetwork-partisan, fig.width=7, fig.height=6}
...
```{r ggnetwork-edge-betweenness, fig.width=7, fig.height=6}
p + aes(color = edge_betweenness) + labs(color = "Edge Betweenness")
```


```{r ggnetwork-node-betweenness, fig.width=7, fig.height=6}
...
```{r ggnetwork-degree, fig.width=7, fig.height=6}
...
```{r ggraph, fig.width=6, fig.height=6, cache= FALSE}
...
```{r ggraph-subset, fig.width=7, fig.height=6, cache=FALSE}
p + facet_wrap("comm")
...
```{r gggraph-edge-betweenness, fig.width=7, fig.height=6}
ggraph(g, layout = 'fr') + 
...
```{r gggraph-betweenness, fig.width=7, fig.height=6}
...
```{r gggraph-coreness, eval=FALSE, fig.width=7, fig.height=6}
...
```{r gggraph-degree, fig.width=7, fig.height=6}
ggraph(g, layout = 'fr') + 
...
```{r pub-table, fig.width=7, fig.height=6, eval = FALSE}
#Publication Table
citations <- c(literature$cites)


load(here("Data", "master_bibliography.rda"))

master_bib <- master_bib %>% 
  filter(str_detect(paste(citations, collapse = "|"), Author))

pub_table <- master_bib %>% 
